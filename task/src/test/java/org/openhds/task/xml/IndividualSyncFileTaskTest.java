...
public class IndividualSyncFileTaskTest {
    ...
    // Current implementation of the IndividualSyncFileTask will only generate
    ...
    public void shouldWriteXml() {
        ...
        try {
            ...
            IndividualSyncFileTask task = new IndividualSyncFileTask(asyncTaskService, sessionFactory);
