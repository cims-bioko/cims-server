...
public class FieldWorkerXmlWriterTask extends XmlWriterTemplate<FieldWorkerXmlWriterTask.FieldWorkerXml> {

    @Autowired
    public FieldWorkerXmlWriterTask(AsyncTaskService asyncTaskService, SessionFactory factory) {
