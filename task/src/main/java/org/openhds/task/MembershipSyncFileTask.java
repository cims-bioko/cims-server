...
public class MembershipSyncFileTask extends SyncFileTemplate<MembershipSyncFileTask.MembershipXml> {

    @Autowired
    public MembershipSyncFileTask(AsyncTaskService asyncTaskService, SessionFactory factory) {
