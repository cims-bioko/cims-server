...
create table locationhierarchy (uuid varchar(32) not null, deleted bit not null, insertDate date, voidDate datetime, voidReason varchar(255), status varchar(255), statusMessage varchar(255), extId varchar(255) not null, name varchar(255) not null, level_uuid varchar(32), parent_uuid varchar(32), insertBy_uuid varchar(32), voidBy_uuid varchar(32), collectedBy_uuid varchar(32) not null, locationLevel_uuid varchar(32), primary key (uuid)) ENGINE=InnoDB;
