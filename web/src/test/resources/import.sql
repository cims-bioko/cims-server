...
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,gender,dob,mother_uuid,father_uuid,insertBy_uuid,insertDate,status,dobAspect,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid,age,ageUnits,phoneNumber,otherPhoneNumber,languagePreference,pointOfContactName,pointOfContactPhoneNumber,dip,memberStatus) VALUES('Unknown Individual','UNK','Unknown',NULL,'UNKNOWN','M', '1900-12-19', NULL, NULL,'User 1','2009-12-19','P','1',NULL,NULL,NULL,false,'UnknownFieldWorker','25','years','123-456-7890','123-456-7890','Spanish','Bob Johnson','123-456-7890','23','permanent')
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,gender,dob,mother_uuid,father_uuid,insertBy_uuid,insertDate,status,dobAspect,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid,age,ageUnits,phoneNumber,otherPhoneNumber,languagePreference,pointOfContactName,pointOfContactPhoneNumber,dip,memberStatus) VALUES ('Individual2','NBAS1I','Nancy',NULL,'Bassey','F', '1959-12-19', 'Unknown Individual', 'Unknown Individual','User 1','2009-12-19','P','1',NULL,NULL,NULL,false,'FieldWorker1','25','years','123-456-7890','123-456-7890','Spanish','Bob Johnson','123-456-7890','23','permanent')
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,gender,dob,mother_uuid,father_uuid,insertBy_uuid,insertDate,status,dobAspect,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid,age,ageUnits,phoneNumber,otherPhoneNumber,languagePreference,pointOfContactName,pointOfContactPhoneNumber,dip,memberStatus) VALUES ('Individual3','BJOH1J','Bob',NULL,'Johnson','M', '1965-12-19', 'Unknown Individual', 'Unknown Individual','User 1','2009-12-19','P','1',NULL,NULL,NULL,false,'FieldWorker1','25','years','123-456-7890','123-456-7890','Spanish','Bob Johnson','123-456-7890','23','permanent')
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,gender,dob,mother_uuid,father_uuid,insertBy_uuid,insertDate,status,dobAspect,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid,age,ageUnits,phoneNumber,otherPhoneNumber,languagePreference,pointOfContactName,pointOfContactPhoneNumber,dip,memberStatus) VALUES ('Individual4','CBLA1H','Cristen',NULL,'Blake','F', '1960-12-19', 'Unknown Individual', 'Unknown Individual','User 1','2009-12-19','P','1',NULL,NULL,NULL,false,'FieldWorker1','25','years','123-456-7890','123-456-7890','Spanish','Bob Johnson','123-456-7890','23','permanent')
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,gender,dob,mother_uuid,father_uuid,insertBy_uuid,insertDate,status,dobAspect,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid,age,ageUnits,phoneNumber,otherPhoneNumber,languagePreference,pointOfContactName,pointOfContactPhoneNumber,dip,memberStatus) VALUES ('Individual5','BHAR1K','Brian',NULL,'Blake','M', '1965-12-19', 'Unknown Individual', 'Unknown Individual','User 1','2009-12-19','P','1',NULL,NULL,NULL,false,'FieldWorker1','25','years','123-456-7890','123-456-7890','Spanish','Bob Johnson','123-456-7890','23','permanent')
