...
public class UserDetailsService implements org.springframework.security.core.userdetails.UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException, DataAccessException {
        ...
        com.github.cimsbioko.server.domain.model.User user = users.get(0);

        return convertUser(user);
    }

    /**
     * Convert a {@link User} instance (defined in OpenHDS) to a {@link UserDetails} instance used by Spring Security
     *
     * @param user the {@link User} instance within OpenHDS
     * @return a {@link UserDetails} instance compatible with Spring Security
     */
    private UserDetails convertUser(com.github.cimsbioko.server.domain.model.User user) {
