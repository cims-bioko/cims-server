create or replace function create_map(locality_uuid locationhierarchy.uuid%type, map_name locationhierarchy.name%type) returns locationhierarchy.uuid%type as $$
declare
...
create or replace function create_sector(map_uuid locationhierarchy.uuid%type, sector_name locationhierarchy.name%type) returns locationhierarchy.uuid%type as $$
declare
