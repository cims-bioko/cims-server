create table form_submission (instanceId varchar(255), as_xml xml not null, as_json jsonb not null, form_id varchar(255) not null, form_version varchar(255) not null, from_device varchar(255) not null, submitted timestamp not null default current_timestamp, primary key (instanceId));
