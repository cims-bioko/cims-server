...
CREATE TABLE IF NOT EXISTS individuals (_id INTEGER,uuid TEXT PRIMARY KEY NOT NULL,dob TEXT,extId TEXT,firstName TEXT,gender TEXT,lastName TEXT,currentResidence TEXT,otherNames TEXT,phoneNumber TEXT,otherPhoneNumber TEXT,pointOfContactName TEXT,pointOfContactPhoneNumber TEXT,languagePreference TEXT,status TEXT,nationality TEXT,otherId TEXT)
