...
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,gender,dob,insertDate,deleted,collectedBy_uuid,phoneNumber,otherPhoneNumber,languagePreference,pointOfContactName,pointOfContactPhoneNumber,dip) VALUES('Unknown Individual','UNK','Unknown',NULL,'UNKNOWN','M', '1900-12-19','2009-12-19',false,'UnknownFieldWorker','123-456-7890','123-456-7890','Spanish','Bob Johnson','123-456-7890','23')
...
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,gender,dob,insertDate,deleted,collectedBy_uuid,phoneNumber,otherPhoneNumber,languagePreference,pointOfContactName,pointOfContactPhoneNumber,dip) VALUES ('Individual3','BJOH1J','Bob',NULL,'Johnson','M', '1965-12-19','2009-12-19',false,'FieldWorker1','123-456-7890','123-456-7890','Spanish','Bob Johnson','123-456-7890','23')
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,gender,dob,insertDate,deleted,collectedBy_uuid,phoneNumber,otherPhoneNumber,languagePreference,pointOfContactName,pointOfContactPhoneNumber,dip) VALUES ('Individual4','CBLA1H','Cristen',NULL,'Blake','F', '1960-12-19','2009-12-19',false,'FieldWorker1','123-456-7890','123-456-7890','Spanish','Bob Johnson','123-456-7890','23')
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,gender,dob,insertDate,deleted,collectedBy_uuid,phoneNumber,otherPhoneNumber,languagePreference,pointOfContactName,pointOfContactPhoneNumber,dip) VALUES ('Individual5','BHAR1K','Brian',NULL,'Blake','M', '1965-12-19','2009-12-19',false,'FieldWorker1','123-456-7890','123-456-7890','Spanish','Bob Johnson','123-456-7890','23')
...
INSERT INTO location(uuid,extId,locationName,locationHierarchy_uuid,locationType,insertDate,deleted,collectedBy_uuid) VALUES ('LOCATION1','NJA001','House 3','hierarchy_root','RUR','2000-12-19',false,'FieldWorker1')

INSERT INTO socialgroup(uuid,extId,deleted,insertdate,groupName,collectedby_uuid,grouphead_uuid,groupType) VALUES ('BasseyFamily', 'MBI1', false, '1979-12-19', 'Bassey Family', 'FieldWorker1','Individual2','FAM')

INSERT INTO residency(uuid,location_uuid,individual_uuid,collectedBy_uuid,deleted,insertDate) VALUES ('residency_uuid1','LOCATION1','Individual5','FieldWorker1',false,'1990-11-20')
