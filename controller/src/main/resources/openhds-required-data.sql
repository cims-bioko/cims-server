...
INSERT INTO privilege VALUES ('PRIVILEGE13', 'ACCESS_TABLET_UI');
...
INSERT INTO role_privileges (role_uuid, privilege_uuid) VALUES ('ROLE1', 'PRIVILEGE13');
...
-- Defined Admin user
INSERT INTO users (uuid, firstName, lastName, fullName, description, username, password, lastLoginTime, deleted) VALUES ('User 1', 'OpenHDS', 'Administrator', 'Administrator', 'Administrator User', 'admin', 'test', 0, false);
...
-- Field Worker
INSERT INTO fieldworker (uuid, extid, firstname, lastname, passwordHash, deleted, idPrefix) VALUES ('UnknownFieldWorker','UNK', 'Unknown', 'FieldWorker', 'invalid-password-hash', false, 0);
