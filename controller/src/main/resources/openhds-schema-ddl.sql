...
create table users (uuid varchar(32) not null, deleted bit not null, description varchar(255), firstName varchar(255), fullName varchar(255), lastLoginTime bigint not null, lastName varchar(255), password varchar(255), sessionId varchar(255), username varchar(255), primary key (uuid)) ENGINE=InnoDB
...
alter table death add index FK5B0927497735AF9 (insertBy_uuid), add constraint FK5B0927497735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table death add index FK5B09274A726FBE (voidBy_uuid), add constraint FK5B09274A726FBE foreign key (voidBy_uuid) references users (uuid)
...
alter table fieldworker add index FK528ED0F897735AF9 (insertBy_uuid), add constraint FK528ED0F897735AF9 foreign key (insertBy_uuid) references users (uuid)
alter table fieldworker add index FK528ED0F8A726FBE (voidBy_uuid), add constraint FK528ED0F8A726FBE foreign key (voidBy_uuid) references users (uuid)
alter table individual add index FKFD3DA29997735AF9 (insertBy_uuid), add constraint FKFD3DA29997735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table individual add index FKFD3DA299A726FBE (voidBy_uuid), add constraint FKFD3DA299A726FBE foreign key (voidBy_uuid) references users (uuid)
...
alter table inmigration add index FKD692204997735AF9 (insertBy_uuid), add constraint FKD692204997735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table inmigration add index FKD6922049A726FBE (voidBy_uuid), add constraint FKD6922049A726FBE foreign key (voidBy_uuid) references users (uuid)
...
alter table location add index FK714F9FB597735AF9 (insertBy_uuid), add constraint FK714F9FB597735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table location add index FK714F9FB5A726FBE (voidBy_uuid), add constraint FK714F9FB5A726FBE foreign key (voidBy_uuid) references users (uuid)
alter table location add index FK714F9FB5DFDC7027 (locationHierarchy_uuid), add constraint FK714F9FB5DFDC7027 foreign key (locationHierarchy_uuid) references locationhierarchy (uuid)
...
alter table membership add index FKB01D87D697735AF9 (insertBy_uuid), add constraint FKB01D87D697735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table membership add index FKB01D87D6A726FBE (voidBy_uuid), add constraint FKB01D87D6A726FBE foreign key (voidBy_uuid) references users (uuid)
...
alter table note add index FK33AFF297735AF9 (insertBy_uuid), add constraint FK33AFF297735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table note add index FK33AFF2A726FBE (voidBy_uuid), add constraint FK33AFF2A726FBE foreign key (voidBy_uuid) references users (uuid)
...
alter table outmigration add index FKE109DC4097735AF9 (insertBy_uuid), add constraint FKE109DC4097735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table outmigration add index FKE109DC40A726FBE (voidBy_uuid), add constraint FKE109DC40A726FBE foreign key (voidBy_uuid) references users (uuid)
...
alter table pregnancyobservation add index FKDB9E9ADF97735AF9 (insertBy_uuid), add constraint FKDB9E9ADF97735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table pregnancyobservation add index FKDB9E9ADFA726FBE (voidBy_uuid), add constraint FKDB9E9ADFA726FBE foreign key (voidBy_uuid) references users (uuid)
alter table pregnancyoutcome add index FKA53B1B8597735AF9 (insertBy_uuid), add constraint FKA53B1B8597735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table pregnancyoutcome add index FKA53B1B85A726FBE (voidBy_uuid), add constraint FKA53B1B85A726FBE foreign key (voidBy_uuid) references users (uuid)
...
alter table relationship add index FKF064763897735AF9 (insertBy_uuid), add constraint FKF064763897735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table relationship add index FKF0647638A726FBE (voidBy_uuid), add constraint FKF0647638A726FBE foreign key (voidBy_uuid) references users (uuid)
...
alter table residency add index FK7E9A5B1A97735AF9 (insertBy_uuid), add constraint FK7E9A5B1A97735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table residency add index FK7E9A5B1AA726FBE (voidBy_uuid), add constraint FK7E9A5B1AA726FBE foreign key (voidBy_uuid) references users (uuid)
...
alter table role add index FK35807697735AF9 (insertBy_uuid), add constraint FK35807697735AF9 foreign key (insertBy_uuid) references users (uuid)
alter table role add index FK358076A726FBE (voidBy_uuid), add constraint FK358076A726FBE foreign key (voidBy_uuid) references users (uuid)
...
alter table socialgroup add index FK89CF7B3297735AF9 (insertBy_uuid), add constraint FK89CF7B3297735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table socialgroup add index FK89CF7B32A726FBE (voidBy_uuid), add constraint FK89CF7B32A726FBE foreign key (voidBy_uuid) references users (uuid)
alter table user_roles add index FK73429949195798DE (user_uuid), add constraint FK73429949195798DE foreign key (user_uuid) references users (uuid)
...
alter table visit add index FK6B04D4B97735AF9 (insertBy_uuid), add constraint FK6B04D4B97735AF9 foreign key (insertBy_uuid) references users (uuid)
...
alter table visit add index FK6B04D4BA726FBE (voidBy_uuid), add constraint FK6B04D4BA726FBE foreign key (voidBy_uuid) references users (uuid)
