INSERT INTO `user` (uuid, firstName, lastName, fullName, description, username, password, lastLoginTime, deleted) VALUES ('e67f2870c59c11e39c1a0800200c9a66', 'Ben', 'Heasly', 'Ben Heasly Import Script', 'Bulk import from Master_DB_All_Houses - Round19v1 spreadsheet', 'bsh-bulk-import', 'bsh-bulk-import', unix_timestamp(), false);
...
INSERT INTO `locationhierarchy` (uuid,name,extId,level_uuid,parent_uuid) VALUES ('36ec15f0c5ae11e39c1a0800200c9a66','Bioko','BI','e8031610c5ac11e39c1a0800200c9a66','HIERARCHY_ROOT');
