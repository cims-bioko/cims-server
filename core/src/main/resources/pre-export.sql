...
CREATE TABLE IF NOT EXISTS individuals (_id INTEGER,uuid TEXT PRIMARY KEY NOT NULL,dob TEXT,extId TEXT NOT NULL,firstName TEXT NOT NULL,gender TEXT,lastName TEXT NOT NULL,currentResidence TEXT,relationshipToHead TEXT,otherNames TEXT,phoneNumber TEXT,otherPhoneNumber TEXT,pointOfContactName TEXT,pointOfContactPhoneNumber TEXT,languagePreference TEXT,status TEXT,nationality TEXT,otherId TEXT, attrs TEXT)
CREATE TABLE IF NOT EXISTS locations (_id INTEGER,extId TEXT NOT NULL,uuid TEXT NOT NULL PRIMARY KEY,hierarchyUuid TEXT NOT NULL,latitude TEXT,longitude TEXT,mapAreaName TEXT,sectorName INT,buildingNumber INT,description TEXT,name TEXT NOT NULL, attrs TEXT)
